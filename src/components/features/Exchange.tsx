    ...
    <div className="flex flex-col gap-2 relative">
      <div className="bg-[#1D1D1D] p-4 flex justify-between items-center rounded-[8px]">
        <div className="flex flex-col gap-1 w-[144px]">
          ...
          <div className="flex flex-row items-center bg-[#0F0F0F] rounded-[8px] h-[42px] px-2 justify-between" onClick={() => handleOpen("sell")}>
            <div className="flex flex-row items-center gap-2">
              <img src="/images/Tether(USDT).png" alt="USDT" className="w-[26px] h-[26px] object-contain" />
              <p className="p1 text-[#E5FFF2]">{sell}</p>
            </div>
      ...
      <div className="bg-[#1D1D1D] p-4 flex justify-between items-center rounded-[8px]">
        <div className="flex flex-col gap-1 w-[144px]">
          ...
          <div className="flex flex-row items-center bg-[#0F0F0F] rounded-[8px] h-[42px] px-2 justify-between" onClick={() => handleOpen("buy")}>
            <div className="flex flex-row items-center gap-2">
              <img src="/images/Tether(USDT).png" alt="USDT" className="w-[26px] h-[26px] object-contain" />
              <p className="p1 text-[#E5FFF2]">{buy}</p>
            </div>
            <img src="/icons/arrow.svg" alt="arrow" />
          </div>
        </div>
