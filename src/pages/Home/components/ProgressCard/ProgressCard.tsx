  ...
  return (
    <Tilt tiltMaxAngleX={6} tiltMaxAngleY={6} glareEnable={false} className="w-full">
      <motion.div
        whileHover={{
          scale: 1.03,
          boxShadow: "0px 0px 20px rgba(255, 255, 100, 0.2)",
        }}
        transition={{ type: "spring", stiffness: 200, damping: 15 }}
        className="bg-[#0D0D0D] border border-[#181818] rounded-xl flex flex-col md:flex-row md:bg-[url('/bg/dots_card.png')] bg-no-repeat bg-contain bg-right"
      >
        <div className="w-full h-[200px] md:h-full md:w-[40%] mr-20">
          <img src={img} alt="home-card" className="size-full object-cover" />
        </div>
        <div className="flex flex-col w-full p-4 md:p-0 md:w-[40%] items-start justify-center gap-3 md:gap-5">
          <InfoTitle isDot={true} text={step} />
