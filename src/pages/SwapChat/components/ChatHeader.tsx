...
const ChatHeader = () => {
  return (
    <div className="p-4 border-b border-[#181818] flex flex-row justify-between w-full items-start md:items-center">
      <div className="flex flex-row gap-3 items-center">
        <div className="w-[40px] h-[40px] rounded-[50%] bg-[#7B7B7B]" />
        <div className="flex flex-col gap-1 md:gap-2">
          <div className="flex flex-row gap-2 items-center">
            <p className="text-[#E5FFF2] p1 leading-[150%]">
              AnnTomson
            </p>
      ...
      <div className="flex flex-col md:flex-row gap-3">
        <BorderButton
          ...
          className="h-[35px] md:h-[34px] text-[12px] md:text-[14px]"
        />
